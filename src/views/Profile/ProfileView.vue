    ...
    <div class="bg-white p-8 rounded-xl border flex flex-col">
      <div class="flex-1">
        ...
        <InputForm text="Contraseña" name="current_password" v-model="formPasword.current_password"
          placeholder="Ingrese su contraseña actual" :type="showPassword ? 'text' : 'password'" />
        <InputForm text="Nueva contraseña" name="password" v-model="formPasword.password"
          placeholder="Ingrese la nueva contraseña" :type="showPassword ? 'text' : 'password'" />
        <InputForm text="Confirmar contraseña" name="password" v-model="formPasword.password_confirmation"
          placeholder="Confirmar la nueva contraseña" :type="showPassword ? 'text' : 'password'" />
